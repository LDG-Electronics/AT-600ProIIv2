...
#define move_cursor_to_prompt() term_cursor_set(3, PROMPT_LINE)

void draw_romedit_prompt(void) {
    term_cursor_set(0, PROMPT_LINE);
    print("\033[1;31;40m");
    print("> ");
...
int8_t romedit_keys(key_t key) {
    ...
    case RIGHT:
        ...
        return 0;
    case PAGEUP:
        if (decrement_address(256)) {
            break;
        }
        return 0;
    case PAGEDOWN:
        if (increment_address(256)) {
            break;
        }
        return 0;
    case F5:
